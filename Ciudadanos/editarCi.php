...
<form enctype="multipart/form-data" action="" method="post"> 
  ...
  <div class="col-md-3"></div>
    <div class="col-md-6">
    <div class="card-header bg-light mb-3 center-text"> <h2>Editar partido</h2>
    <div class="row">
    <div class="col-md-1"></div>
      <div class="col-md-5 mb-3">
      <input type="text" class="form-control" value = "<?php echo $gelement->cedula; ?>" placeholder="nombre" name = "cedula"> 
   </div>
   </div>
   ...
   <div class="col-md-12 mb-3">
      <input type="text" class="form-control"  value = " <?php echo $gelement->email;?>" placeholder="email" name = "email">
   </div>
